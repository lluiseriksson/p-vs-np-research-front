...
| GATE-004S | EXPLORATORY | Prove polynomial average loss for every total function agreeing exactly with SAT-gamma on the complete ENC-016 expanded-cube cylinder | `proofs/GATE-004S-exact-sat-expanded-context-cube.md` | Active smallest brick; sufficient for GATE-004Q |
