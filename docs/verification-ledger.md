...
| GATE-004R | EXPLORATORY | Prove polynomial average loss for every total function agreeing exactly with SAT-gamma on the radius-two ENC-014 prefix cylinder | `proofs/GATE-004R-radius-two-sat-rigidity.md` | Active smallest brick; sufficient for GATE-004Q |
